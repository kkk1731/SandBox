...
/* kernel/return_constant_test.c*/
asmlinkage long sys_return_constant_test(void);
/* kernel/write_syslog_test.c*/
asmlinkage long sys_write_syslog_test(char *msg);
/* kernel/ptr5000_test.c*/
asmlinkage long sys_ptr5000_test(int *a);
/* kernel/neogetpid_test.c*/
asmlinkage long sys_neogetpid_test(void);

/* kernel/sandbox_test.c*/
asmlinkage long sys_register_sandbox(int pid);
asmlinkage long sys_clear_sandlist(int pid);
